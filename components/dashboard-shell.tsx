  ...
  return (
    <div className="flex min-h-screen bg-paper lg:flex-row">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <footer className="flex items-center justify-center gap-4 border-t border-border bg-surface px-4 py-3 font-util text-xs text-ink/50">
          <Link href="/terms" className="hover:text-ink">תנאי שימוש</Link>
          <Link href="/privacy" className="hover:text-ink">מדיניות פרטיות</Link>
        </footer>
      </div>
    </div>
  );
